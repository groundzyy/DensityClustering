...
public class TestDensityClusterer_MatrixFileDistanceBuilder {
	public static void main(String[] args) throws IOException {
		...
		String distanceFilePath = ".//sample//example.distancematrix";
		
		distanceFilePath = "./Gm12878.H3k4me1.tss.all.matrix";
		
		DensityClusterer dClusterer = new DensityClusterer();
		MatrixFileDistanceBuilder distBuilder = new MatrixFileDistanceBuilder(distanceFilePath, new GaussianKernalDensityCalculator());
